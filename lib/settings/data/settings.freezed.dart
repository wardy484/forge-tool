...
class _$SettingsTearOff {
  ...
  _Settings call({required String name, required String apiKey}) {
    return _Settings(
      name: name,
      apiKey: apiKey,
    );
...
abstract class $SettingsCopyWith<$Res> {
  ...
  $Res call({String name, String apiKey});
}
...
class _$_Settings implements _Settings {
  _$_Settings({required this.name, required this.apiKey});
  ...
  @override
  String toString() {
    return 'Settings(name: $name, apiKey: $apiKey)';
  }
...
abstract class _Settings implements Settings {
  factory _Settings({required String name, required String apiKey}) =
      _$_Settings;
