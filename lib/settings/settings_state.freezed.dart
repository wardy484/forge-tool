...
mixin _$SettingsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Settings settings) valid,
    required TResult Function(Settings settings, String error) error,
  }) =>
...
class _$ValidImpl implements _Valid {
  ...
  @override
  String toString() {
    return 'SettingsState.valid(settings: $settings)';
  }
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'SettingsState.error(settings: $settings, error: $error)';
  }
